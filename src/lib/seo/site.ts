...
export const publicPages = [
  ...
  { path: "/features", title: "AI video creation tools", description: "Compare ETA's faceless video, cartoon, UGC ad and podcast Shorts workflows.", modifiedAt: "2026-09-25" },
