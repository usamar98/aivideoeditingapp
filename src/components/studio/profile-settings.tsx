...
export function ProfileSettings({ email, initialUsername, demo, plans, subscription, credits, billingMessage, initialTab = "profile", initialInterval = "month", selectedTier }: { email: string; initialUsername: string; demo: boolean; plans: OfferedBillingPlan[]; subscription: SubscriptionView | null; credits: number; billingMessage: string | null; initialTab?: "profile" | "billing"; initialInterval?: BillingInterval; selectedTier?: string }) {
