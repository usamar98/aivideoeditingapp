...
export default function PricingPage() {
  return <MarketingPage title="A credit budget for your next story." description="Choose monthly flexibility or an annual subscription. All three tiers support the same creative workflows; the difference is your credit budget." eyebrow="ETA plans and pricing">
    ...
    <section className="grid gap-8 md:grid-cols-2">
      <div><h2 className="text-xl font-semibold">How many videos can I create?</h2><p className="mt-3 text-sm leading-7 text-muted-foreground">It depends on the workflow, video duration and selected model. The studio displays a credit estimate before each paid generation stage. AI script planning, cast creation and video rendering can have separate costs. Compare the <Link className="text-primary underline" href="/features/faceless-video-generator">faceless workflow</Link> with the <Link className="text-primary underline" href="/features/ai-cartoon-series">cartoon workflow</Link> before choosing a plan.</p></div>
