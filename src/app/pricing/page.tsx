...
export default function PricingPage() {
  return <MarketingPage title="A credit budget for your next story." description="Choose monthly flexibility or an annual subscription. All three tiers support the same creative workflows; the difference is your credit budget." eyebrow="ETA plans and pricing">
    ...
    <section><h2 className="editorial text-3xl">What does each billing option include?</h2><p className="mt-4 text-sm leading-7 text-muted-foreground">The table below shows standard base (1×) prices and credit allowances in US dollars, before introductory offers. Any limited-time offer’s initial-period terms are shown on its card above. Use the credit menu to select 1×, 2× or 3× the credits; larger bundles include the displayed discount. Annual subscriptions are charged as one annual payment, not as twelve monthly payments. The full yearly credit allocation is issued upfront.</p>
